...
def FD(grating: TwoBox) -> float:
    ...
    if npaLA.det(J)==0:
        ...
        print(grating.grating_depth)
        print(grating.box1_width)
        print(grating.box2_width)
        print(grating.box_centre_dist)
        print(grating.box1_eps)
        print(grating.box2_eps)
        print(grating.gaussian_width)
        print(grating.substrate_depth)
