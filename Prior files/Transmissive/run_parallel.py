...
from opt_updated import FOM_uniform, global_optimise
...
final_speed = 20 # percentage of c  # 20
...
ndof = 11            # was 8 - add width, substrate: depth, eps
...
if __name__ == '__main__':
    with Pool(processes=num_cores) as pool:
        ...
        for optimum in all_optima:
            ...
            opt_params = optimum[1]
            grating_copy = deepcopy(grating)
            grating_copy.params = opt_params
            opt_gratings.append(grating_copy) 

        data = {'Optimised grating': opt_gratings, 'FOM': opt_FOMs, 
