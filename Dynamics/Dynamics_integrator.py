...
maxtime = 1440
output_opt_idx = 18  # Index of the optimum grating to output, lower corresponding to larger FOM
...
velocity_MAX = 0.2*c
h = 1e-3   # Step size  
runID = "Fasymp20_cutoff"  # For saving dynamics data
